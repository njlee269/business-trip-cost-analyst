    ...
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 overflow-hidden">
          ...
          <div className="absolute top-20 left-1/4 w-96 h-96 bg-red-50/20 rounded-full blur-3xl" />
          <div className="absolute bottom-10 right-1/4 w-80 h-80 bg-gray-100/40 rounded-full blur-3xl" />

          <div className="relative max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-gray-50 border border-gray-200 rounded-full text-xs text-gray-500 mb-8 animate-fade-in">
