        ...
        <div className="mb-8">
          <div className="flex items-center justify-center mb-4">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" className="opacity-80">
              <path d="M20 2 L20 30 M20 30 L17 25 M20 30 L23 25" stroke="#111827" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M8 18 L15 16" stroke="#111827" strokeWidth="2.5" strokeLinecap="round"/>
              <path d="M32 18 L25 16" stroke="#111827" strokeWidth="2.5" strokeLinecap="round"/>
            </svg>
          </div>
